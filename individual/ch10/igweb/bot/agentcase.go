...
func (a *AgentCase) initializeIntelligence() {
	...
	a.knowledgeBase = map[string]string{
		...
		"starter code starter kit":                                                                "The isogoapp, is a basic, barebones web app, intended to be used as a starting point for developing an Isomorphic Go application. Here's the link to the github page: https://go.isomorphicgo.org/go/isogoapp",
