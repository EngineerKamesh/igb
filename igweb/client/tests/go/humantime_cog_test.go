...
func main() {
	...
	casper.Call("then", func() {
		...
		casper.Get("test").Call("assertSelectorHasText", "#Gopher-Molly .timeagoSpan", mollysStartDateInHumanTime, "Verify human time of Molly's start date produced by Time Ago Cog.")
	})
